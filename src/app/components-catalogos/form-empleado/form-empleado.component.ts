...
export class FormEmpleadoComponent implements OnInit {
  ...
  constructor(private catalogosServices: CatalogosService, private router: Router, private activateRoute: ActivatedRoute, private usuarioService: UsuarioService) {
    this.empleado = new FormGroup({
      ...
      'dui': new FormControl("", [Validators.required, Validators.minLength(10)], this.noRepetirDui.bind(this)),
      'nombres': new FormControl("", [Validators.required, Validators.maxLength(50), Validators.pattern("^[[a-zA-ZÑÁÉÍÓÚáéíóúñ ]+$")]),
      'apellidos': new FormControl("", [Validators.required, Validators.maxLength(50), Validators.pattern("^[[a-zA-ZÑÁÉÍÓÚáéíóúñ ]+$")]),
      ...
      'telefonopersonal': new FormControl("", [Validators.required, Validators.minLength(9)]),
