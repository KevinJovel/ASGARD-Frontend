...
export class FormEmpleadoComponent implements OnInit {
  ...
  constructor(private catalogosServices: CatalogosService, private router: Router, private activateRoute: ActivatedRoute, private usuarioService: UsuarioService) {
    this.empleado = new FormGroup({
      ...
      'nombres': new FormControl("", [Validators.required, Validators.maxLength(50), Validators.pattern("^[A-ZÑÁÉÍÓÚ ]+$")]),
      'apellidos': new FormControl("", [Validators.required, Validators.maxLength(50), Validators.pattern("^[A-ZÑÁÉÍÓÚ ]+$")]),
